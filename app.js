...
const JS_API_KEY = 'YOUR_AMAP_JS_KEY_HERE';
const SECURITY_CODE = 'YOUR_AMAP_SECURITY_CODE_HERE'; // Only needed if you don't use proxy, but JS API loader handles key mainly.
